...
import { 
   ...
   * Only checks auth for operations that modify data
   */
  const checkJWTAdminPrivilegesForWrites = async (operation) => {
    console.log(`🔐 [DEBUG] checkJWTAdminPrivilegesForWrites called for operation: ${operation}`);
    ...
    if (['setDocument', 'addDocument', 'updateDocument', 'deleteDocument'].includes(operation)) {
      console.log('🔐 [DEBUG] This is a write operation, checking auth...');
  ...
  export const setDocument = async (collectionName, docId, data) => {
    try {
      ...
      // Check JWT admin privileges for write operations
      await checkJWTAdminPrivilegesForWrites('setDocument');
  ...
  export const addDocument = async (collectionName, data) => {
    try {
      ...
      // Check JWT admin privileges for write operations
      await checkJWTAdminPrivilegesForWrites('addDocument');
  ...
  export const updateDocument = async (collectionName, docId, data) => {
    try {
      ...
      // Check JWT admin privileges for write operations
      await checkJWTAdminPrivilegesForWrites('updateDocument');
  ...
  export const deleteDocument = async (collectionName, docId) => {
    try {
      ...
      // Check JWT admin privileges for write operations
      await checkJWTAdminPrivilegesForWrites('deleteDocument');
  ...
  console.log('✅ [DEBUG] Firebase database module loaded with JWT auth support');
