    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link
            to="/projects"
            className="text-blue-600 hover:text-orange-600 flex items-center gap-2 justify-center"
          >
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-6">
        <Link
          to="/projects"
          className="text-blue-600 hover:text-orange-600 flex items-center gap-2"
        >
          <ArrowLeft className="w-4 h-4" />
          Back to Projects
        </Link>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-blue-500 text-white p-6 rounded-lg">
                ...
                <div className="space-y-2">
                  <Link
                    to="/contact"
                    className="block text-center bg-white text-blue-600 px-6 py-2 rounded-lg font-semibold hover:bg-blue-50 transition-colors"
                  >
                    Contact Us
                  </Link>
                  <Link
                    to="/schedule"
                    className="block text-center border border-white px-6 py-2 rounded-lg font-semibold hover:bg-blue-600 transition-colors"
                  >
                    Schedule Service
                  </Link>
                </div>
